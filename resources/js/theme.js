...
function updateToggleButton(theme) {
  ...
  toggleBtns.forEach(toggleBtn => {
    ...
    const label = toggleBtn.querySelector('span');  // Note: Mobile uses plain <span>, desktop uses .theme-label
    if (!label) return;
    if (theme === 'dark') {
      // Current dark → show "Light" (switch to light)
      ...
      // Current light → show "Dark" (switch to dark)
