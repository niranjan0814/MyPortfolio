...
<body class="bg-gray-50">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-4">
                            ...
                            @auth
                                @if($hasAccess)
                                    ...
                                    @else
                                        <form action="{{ route('themes.activate', $theme) }}" method="POST" class="flex-1">
                                            @csrf
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <!-- Key Features - Matching Landing Style -->
                        @if($theme->features)
    ...
    <!-- Activation Confirmation Modal - Themed -->
            ...
            <div class="p-6">
                <div class="flex items-start gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">This will change your portfolio's appearance immediately. You can switch back to other themes anytime.</p>
                    </div>
                </div>
