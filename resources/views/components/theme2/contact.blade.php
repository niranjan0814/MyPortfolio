                            ...
                            @if($user->email)
                                <div class="contact-info-item">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:{{ $user->email }}" class="contact-info-value">{{ $user->email }}</a>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="mt-8 pt-8 border-t contact-border">
                                ...
                                <div class="flex gap-4">
                                    @if($user->linkedin_url)
                                        <a href="{{ $user->linkedin_url }}" target="_blank" class="contact-social-btn contact-social-linkedin">
                                    ...
                                    @if($user->github_url)
                                        <a href="{{ $user->github_url }}" target="_blank" class="contact-social-btn contact-social-github">
                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
