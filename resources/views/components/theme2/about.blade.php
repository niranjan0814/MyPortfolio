...
<section id="about" class="section-full relative overflow-hidden pt-12 pb-16 theme2-about">
    ...
    <div class="container mx-auto max-w-6xl fade-in relative z-10 px-4">
        ...
        <div class="text-center mb-16">
            ...
            <div class="flex items-center justify-center gap-4">
                <div class="h-px flex-1 max-w-20 cyber-line"></div>
                <div class="w-2 h-2 rotate-45 cyber-diamond"></div>
                <div class="h-px flex-1 max-w-20 cyber-line"></div>
            </div>
        </div>
...
.cyber-icon-box:hover {
    border-color: var(--about-neon-primary);
    box-shadow: 0 0 20px var(--about-particle-color);
}
...
/* Fix overlapping stats grid */
.theme2-about-enhanced .stats-grid {
    display: grid;
