...
<header class="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
    ...
    <nav class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <button id="mobile-menu-btn" class="md:hidden text-2xl transition-colors" style="color: var(--text-primary);">
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 space-y-2 rounded-lg p-4 shadow-lg"
            ...
            <a href="#about" class="block py-2 font-medium transition-colors mobile-menu-link hover:opacity-80" style="color: var(--text-secondary);">About</a>
            <a href="#projects" class="block py-2 font-medium transition-colors mobile-menu-link hover:opacity-80" style="color: var(--text-secondary);">Projects</a>
