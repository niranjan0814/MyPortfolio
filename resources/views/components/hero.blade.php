...
<section id="hero"
   ...
   <div class="mx-auto text-center fade-in relative z-10 px-6 md:px-12 lg:px-20 w-full max-w-7xl">
        ...
        <h1 class="text-5xl mt-14 md:text-7xl lg:text-8xl font-bold mb-6 pl-8 
           whitespace-nowrap inline-flex gap-3 items-center"
            style="color: var(--text-primary); white-space: nowrap !important;">
        ...
        @if (!empty($heroContent['typing_texts']) && is_array($heroContent['typing_texts']) && count($heroContent['typing_texts']) > 0)
            <div class="mb-8 mt-6 md:mt-10 min-h-[60px] flex justify-center items-center">
                <p class="text-xl md:text-3xl font-semibold inline-flex items-center" style="color: var(--text-secondary);">
