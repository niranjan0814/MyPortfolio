...
<style>
    ...
    @media (max-width: 640px) {
        ...
        .t3-footer-content.active {
            display: block;
            animation: t3SlideDown 0.3s ease;
        }

        .t3-footer-icon-rotate {
        ...
        .t3-footer-toggle.active .t3-footer-icon-rotate {
            transform: rotate(-90deg);
        }
...
<footer class="t3-footer">
    <div class="t3-footer-container">
        <div class="t3-footer-grid">
            ...
            <!-- Quick Links -->
            <div class="t3-footer-section">
                <button class="t3-footer-toggle" onclick="toggleFooterSectionT3(this)">
                    <h4 class="t3-footer-title">Quick Links</h4>
                    <span class="t3-footer-icon-rotate hidden sm:hidden" style="display: none;">›</span>
                    <span class="t3-footer-icon-rotate-mobile" style="display: none;">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                    </span>
                </button>
                <div class="t3-footer-content">
                            ...
                            <li class="t3-footer-link">
                                <a href="mailto:{{ $user->email }}">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        ...
                                        style="color: var(--t3-footer-accent);">
        ...
        <div class="t3-footer-bottom">
            <div class="t3-made-with">
                Made with Detech<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none"
                    class="t3-heart">
                    <path
...
<script>
    function toggleFooterSectionT3(button) {
        if (window.innerWidth >= 640) return; // Only work on mobile

        const content = button.nextElementSibling;
        const icon = button.querySelector('.t3-footer-icon-rotate-mobile');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        function checkFooterStateT3() {
            const isMobile = window.innerWidth < 640;
            const contents = document.querySelectorAll('.t3-footer-content');
            const icons = document.querySelectorAll('.t3-footer-icon-rotate-mobile');
            const toggles = document.querySelectorAll('.t3-footer-toggle');
            ...
            // Disable button interaction on desktop
            toggles.forEach(toggle => {
                toggle.style.pointerEvents = isMobile ? 'auto' : 'none';
            });
        }

        checkFooterStateT3();
        window.addEventListener('resize', checkFooterStateT3);
    });
</script>