                ...
                @foreach($projects as $project)
                    <div class="t3-proj-card">
                        ...
                        <div class="t3-proj-footer">
                            ...
                            @if($project->depurl)
                                <a href="{{ $project->depurl }}" target="{{ request()->query('preview') ? '_self' : '_blank' }}" class="t3-proj-btn t3-proj-btn-secondary">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @if($project->link)
                                <a href="{{ $project->link }}" target="{{ request()->query('preview') ? '_self' : '_blank' }}" class="t3-proj-btn t3-proj-btn-secondary">
