                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        @foreach(['About Me|#about','Projects|#projects','Skills|#skills','Contact|#contact'] as $link)
                            ...
                            <li>
                                <a href="{{ $url }}" class="text-gray-300 hover:text-blue-400 transition-colors flex items-center gap-2 group">
                ...
                <div class="space-y-8">
                    ...
                    <div class="mb-8">
                        ...
                        <ul class="space-y-4">
                            ...
                            @if($user->phone)
                            <li>
                                <a href="tel:{{ $user->phone }}" class="text-gray-300 hover:text-blue-400 transition-colors flex items-start gap-3 group">
                            ...
                            @if($user->email)
                            <li>
                                <a href="mailto:{{ $user->email }}" class="text-gray-300 hover:text-blue-400 transition-colors flex items-start gap-3 group">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <a href="{{ $user->github_url }}" target="_blank"
                               class="group relative w-12 h-12 flex items-center justify-center bg-gray-800 rounded-full hover:bg-gradient-to-r hover:from-gray-700 hover:to-gray-900 transition-all duration-300 hover:scale-110 hover:shadow-lg">
                                ...
                                <span class="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-xs px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                                    GitHub
                                </span>
                            </a>
                            @endif
