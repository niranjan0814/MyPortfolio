                    ...
                    <div class="t2-project-card group">
                        ...
                        <div class="t2-project-content">
                            ...
                            <div class="t2-project-actions">
                                ...
                                @if($project->depurl)
                                    <a href="{{ $project->depurl }}" target="_blank" class="t2-project-btn t2-project-btn-outline">
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @if($project->link)
                                    <a href="{{ $project->link }}" target="_blank" class="t2-project-btn t2-project-btn-outline">
