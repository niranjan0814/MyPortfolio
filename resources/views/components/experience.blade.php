...
<section id="experience" class="section-full bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto max-w-6xl fade-in relative z-10 px-4">
        <div class="text-center mb-20">
            <h2 class="text-5xl md:text-6xl font-bold mb-6 leading-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent" style="line-height: 1.2;">
                My Journey
            </h2>
